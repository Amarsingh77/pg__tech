...
router.post('/', protect, authorize('admin'), upload.single('image'), validateTestimonial, createTestimonial);

// @route   PUT /api/testimonials/:id
// @desc    Update testimonial
// @access  Private (Admin)
router.put('/:id', protect, authorize('admin'), validateId, upload.single('image'), validateTestimonial, updateTestimonial);
