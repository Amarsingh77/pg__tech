                    ...
                    <div className="lg:col-span-8">
                        ...
                        >
                            ...
                            <div className="bg-gray-900/30 backdrop-blur-2xl rounded-[3rem] border border-gray-800/50 overflow-hidden shadow-2xl">
                                {/* Tab Headers - Enhanced Mobile Scroll */}
                                <div className="relative">
                                    <div className="flex border-b border-gray-800/50 p-2 bg-gray-900/20 overflow-x-auto no-scrollbar scroll-smooth snap-x">
                                        {['curriculum', 'overview', 'outcomes'].map((tab) => (
                                            <button
                                                key={tab}
                                                onClick={() => setActiveTab(tab)}
                                                className={`flex-none px-6 py-4 rounded-2xl font-bold text-sm uppercase tracking-widest transition-all whitespace-nowrap snap-start mx-1 ${activeTab === tab
                                                    ? `bg-gradient-to-r ${theme.buttonGradient} text-white shadow-lg scale-100`
                                                    : 'text-gray-500 hover:text-gray-300 hover:bg-gray-800/30 scale-95'
                                                    }`}
                                            >
                                                {tab}
                                            </button>
                                    ...
                                    <div className="absolute left-0 top-0 bottom-0 w-4 bg-gradient-to-r from-gray-900/40 to-transparent pointer-events-none md:hidden" />
                                    <div className="absolute right-0 top-0 bottom-0 w-8 bg-gradient-to-l from-gray-900/40 to-transparent pointer-events-none md:hidden" />
                                </div>
